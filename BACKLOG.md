...
> Die ersten fünf Punkte (K1, W2, Occlusion-Glättung, W1+P6, P8): 2026-06-04 (Code-Review-Härtung). **W3** + **M1**: 2026-06-20. **R3**: 2026-06-21.
...
— Aktuell **keine offenen Punkte.** (W3 + M1 + R3 erledigt → siehe ✅ Erledigt.) Nächste offene Härtung steht in 🟡 Mittel (M3, M4, R4).
