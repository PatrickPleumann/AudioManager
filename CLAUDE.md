...
Verantwortung in [`ARCHITECTURE.md`](ARCHITECTURE.md) §2. Aktuell **153 EditMode-Tests**; die pure Schicht
umfasst **19 Einheiten** (die Liste in §2 ist deren Single Source).
